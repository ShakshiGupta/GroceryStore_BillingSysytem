...
// PRoducts name
char productName[18][20]={"sugar","milk","vegetable masala","washing powder","salt","poha","oil","tooth paste","hair conditionar","red chilli","maida","coffee","tea","butter","milk powder",
"turmeric powder","hair oil","ghee"};
//Product price
int sugar_p = 50, milk_p = 50, vegetable_masala_p = 50, wahing_powder_p = 100, salt_p = 20, poha_p = 50, oil_p = 200, tooth_paste_p = 40, hair_conditionar_p = 120, red_chilli_p = 40,
maida_p = 45,coffee_p = 200,tea_p = 100, butter_p = 100, milk_powder_p = 150, turnmeric_powder_p = 200, hair_oil_p = 60, ghee_p = 300;
...
int main(){
    ...
    cout<<"******************************************\n";
    do{
        // to buy product press 1
        cout<<"Press 1 to buy product"<<endl;
        // to calculate bill press 2
        cout<<"Press 2 to calcualte bill"<<endl;
        //  to show the bill press 3
